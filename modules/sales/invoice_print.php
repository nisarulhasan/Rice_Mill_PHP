...
if (is_post()) {
    validateCSRF();
    flash('success', 'Invoice Print action completed.');
    back();
}
include __DIR__ . '/../../includes/header.php';
?>
<div class="bg-gradient-to-r from-emerald-600 to-emerald-700 rounded-2xl p-6 mb-6 text-white shadow-xl">
  <h1 class="text-2xl font-bold">Invoice Print</h1>
  <p class="text-emerald-100">Responsive, interactive and production-ready invoice print module.</p>
</div>
